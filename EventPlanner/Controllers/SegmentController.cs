...
namespace EventPlanner.Controllers
{
    ...
    public class SegmentController : ControllerBase
    {
        ...
        {
                return Segments != null && Segments.Count > 0 ? Segments : new List<Segment>();
        }
        ...
        {
            if (id>=Segments.Count) return null;
            return Segments[id];
        }
        ...
        public IActionResult Post([FromBody] Segment segment)
        {
            ...
            Console.WriteLine(segment + $", \r\nList is now filled with {Segments.Count} entries.");
        ...
        public IActionResult Post(string id, [FromBody] Participant value)
        {
            ...
            return Ok(new { Message = "Segment updated successfully", Value = value });
        }
        ...
        public void Delete(int SegmentId, int ParticipantId)
        {
        }
    }
}
